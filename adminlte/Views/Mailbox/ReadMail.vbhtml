...
<div Class="content-wrapper">
    ...
    <section Class="content-header">
        ...
        <ol Class="breadcrumb">
            <li> <a href = "@Url.Action("Mailbox", "Mailbox")"><i Class="fa fa-dashboard"></i> Home</a></li>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        <ul class="mailbox-attachments clearfix">
                            ...
                            <li>
                                <span class="mailbox-attachment-icon has-img"><img src="~/Content/adminlte/img/photo1.png" alt="Attachment"></span>
                                <div class="mailbox-attachment-info">
                            ...
                            <li>
                                <span class="mailbox-attachment-icon has-img"><img src="~/Content/adminlte/img/photo2.png" alt="Attachment"></span>
                                <div class="mailbox-attachment-info">
